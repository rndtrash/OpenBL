...
function ETerrainEditor::changeMaterial(%this, %matIndex)
{
   ...
   //needs to include the directory that the mission file is in
   // or perhaps even all add-ons/map_* directories
   getLoadFilename("*/terrains/*.png" TAB 
                   "*/terrains/*.jpg" TAB
                   "Add-Ons/Map_*/*.png" TAB
                   "Add-Ons/Map_*/*.jpg", EPainterChangeMat);
}
...
$TerraformerTextureDir = "editor/textureScripts"; //badspot: removed common/
...
//badspot: this is called by the 1.4 interior code
